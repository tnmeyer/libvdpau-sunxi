...
#define VE_MPEG_SOCX            0x160
#define VE_MPEG_SOCY            0x164
#define VE_MPEG_SOL             0x168
#define VE_MPEG_SDLX            0x16c
#define VE_MPEG_SDLY            0x170
#define VE_MPEG_SPRITESHIFT     0x174
#define VE_MPEG_SDCX            0x178
#define VE_MPEG_SDCY            0x17c
#define VE_MPEG_IQ_MIN_INPUT	0x180
#define VE_MPEG_QP_INPUT        0x184
#define VE_MPEG_MSMPEG4_HDR     0x188
#define VE_MPEG_MV5             0x1A8
#define VE_MPEG_MV6             0x1AC
